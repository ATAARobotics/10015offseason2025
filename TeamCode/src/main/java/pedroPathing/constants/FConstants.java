...
public class FConstants {
    static {
        ...
        FollowerConstants.mass = 9.3;

        FollowerConstants.xMovement = 81.9;
        FollowerConstants.yMovement = 64.7;

        FollowerConstants.forwardZeroPowerAcceleration = -35.9;
        FollowerConstants.lateralZeroPowerAcceleration = -71.4;
